...
const MercadoPagoIcon = ({ className = "h-6 w-6" }) => (
  <svg viewBox="195 125 320 165" className={className} xmlns="http://www.w3.org/2000/svg">
    <path className="cls-3" fill="#00bcff" d="m350.04,138.92c-77.83,0-140.91,40.36-140.91,90.15s63.09,94.05,140.91,94.05,140.91-44.27,140.91-94.05-63.09-90.15-140.91-90.15Z"/>
...
const MercadoPagoLogo = ({ className = "h-8" }) => (
  <svg viewBox="100 100 500 480" className={className} xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="max-w-md w-full bg-white rounded-2xl border border-[#E6E6E6] overflow-hidden shadow-sm">
          ...
          <div className="bg-white px-5 py-4 border-b border-[#EEEEEE] flex items-center gap-3">
            ...
            <div className="flex-1">
              <h2 className="text-base font-semibold text-[#333333]">Pagamento</h2>
            </div>
            ...
            {cartItems.map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-[#333333]">{item.nome}</p>
                    <p className="text-xs text-[#999999]">Festa Junina Brandão</p>
                  </div>
                </div>
            ...
            {pixData ? (
              <div className="space-y-4">
                <div className="bg-[#E0F7E9] border border-[#CFF0DD] rounded-xl p-3.5 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#00A650]">Pix gerado com sucesso!</p>
                    <p className="text-xs text-[#4D9D75]">Escaneie ou copie o código abaixo</p>
                  </div>
                </div>
                ...
                {/* Código copia e cola */}
                <div>
                  <p className="text-xs text-[#999999] mb-2 font-medium">Código Pix copia e cola</p>
              ...
              <>
                {/* ── Seletor de método ── */}
                <div>
                  <p className="text-[13px] text-[#999999] mb-2 font-medium">Forma de pagamento</p>
                  <div className="space-y-2">
                    <button
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-[#333333]">Pix</p>
                        <p className="text-xs text-[#999999]">Aprovação imediata</p>
                      </div>
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${
                          paymentMethod === "pix" ? "border-[#009EE3]" : "border-[#CCCCCC]"
                        }`}
                      >
                        {paymentMethod === "pix" && (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-[#333333]">Cartão de crédito ou débito</p>
                        <p className="text-xs text-[#999999]">Visa, Mastercard, Elo e outros</p>
                      </div>
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${
                          paymentMethod === "card" ? "border-[#009EE3]" : "border-[#CCCCCC]"
                        }`}
                      >
                        {paymentMethod === "card" && (
                          <div className="w-2.5 h-2.5 rounded-full bg-[#009EE3]" />
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#F7F7F7] border border-[#EEEEEE] rounded-xl p-3.5 space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-[#333333] font-medium">{currentUser?.nomeResponsavel}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-[#999999]">CPF</span>
                        <span className="text-[#333333] font-medium">{currentUser?.cpf}</span>
                      </div>
                      <div className="flex justify-between text-sm pt-1 border-t border-[#EEEEEE]">
                        <span className="text-[#999999]">Valor</span>
                        <span className="text-[#333333] font-bold">R$ {totalCart.toFixed(2).replace(".", ",")}</span>
                      </div>
                    </div>
                    <Button
                      className="w-full h-14 !bg-[#009EE3] !text-white hover:!bg-[#0089C7] !rounded-lg !font-semibold"
                ...
                {paymentMethod === "card" && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <Label className="!text-[#666666]">Número do cartão</Label>
                        <Input
                          name="number"
                      ...
                      <div>
                        <Label className="!text-[#666666]">Nome no cartão</Label>
                        <Input
                          name="name"
                          value={cardData.name}
                          onChange={handleCardChange}
